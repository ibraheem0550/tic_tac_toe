...
class _ThemeEditorScreenState extends State<ThemeEditorScreen>
  ...
  void _loadExistingTheme(Product theme) {
    ...
    _surfaceColor =
        Color(metadata['surfaceColor'] ?? Colors.grey.shade800.value);
    _cardColor = Color(metadata['cardColor'] ?? const Color(0xFF424242).value);

    _primaryTextColor =
        Color(metadata['primaryTextColor'] ?? Colors.white.value);
    _secondaryTextColor =
        Color(metadata['secondaryTextColor'] ?? Colors.grey.shade300.value);
    _titleTextColor = Color(metadata['titleTextColor'] ?? Colors.yellow.value);

    _primaryButtonColor = Color(
        metadata['primaryButtonColor'] ?? Colors.deepPurple.shade500.value);
    _secondaryButtonColor =
        Color(metadata['secondaryButtonColor'] ?? Colors.teal.shade500.value);
    _dangerButtonColor =
        Color(metadata['dangerButtonColor'] ?? Colors.red.shade500.value);
    _successButtonColor =
        Color(metadata['successButtonColor'] ?? Colors.green.shade500.value);

    _gameXColor = Color(metadata['gameXColor'] ?? Colors.blue.shade400.value);
    _gameOColor = Color(metadata['gameOColor'] ?? Colors.red.shade400.value);
    _gameBoardColor =
        Color(metadata['gameBoardColor'] ?? Colors.grey.shade700.value);
    _gameWinColor =
        Color(metadata['gameWinColor'] ?? Colors.green.shade400.value);
    ...
    _borderColor = Color(metadata['borderColor'] ?? Colors.grey.shade600.value);
    _shadowColor = Color(metadata['shadowColor'] ?? Colors.black54.value);
    _highlightColor = Color(metadata['highlightColor'] ?? Colors.white24.value);
  }
