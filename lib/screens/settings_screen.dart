...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  // دالة بناء محدد اللغة
  Widget _buildLanguageSelector() {
    final availableLanguages = AppLocalizations.getAvailableLanguages();
  ...
  Widget _buildSocialSection() {
    return _buildSection('إدارة طلبات الصداقة', Icons.group, [
      _buildSwitchTile(
        'قبول طلبات الصداقة تلقائياً',
        'تفعيل لقبول طلبات الصداقة الجديدة تلقائياً',
        Icons.person_add,
        false, // يمكن إضافة هذه الخاصية للتفضيلات لاحقاً
        (value) => _updatePreference('autoAcceptFriendRequests', value),
      ),
      _buildSwitchTile(
        'إظهار الحالة الاونلاين',
        'إظهار حالتك الاونلاين للأصدقاء',
        Icons.circle,
        true, // يمكن إضافة هذه الخاصية للتفضيلات لاحقاً
  ...
  Widget _buildPrivacySection() {
    return _buildSection('الخصوصية والأمان', Icons.security, [
      ListTile(
        leading: Icon(Icons.person_remove, color: AppColors.primary),
        title: Text('حظر المستخدمين'),
        subtitle: Text('إدارة قائمة المستخدمين المحظورين'),
      ...
      ListTile(
        ...
        subtitle: Text('الإبلاغ عن محتوى غير مناسب أو مشكلة تقنية'),
        trailing: Icon(Icons.arrow_forward_ios),
